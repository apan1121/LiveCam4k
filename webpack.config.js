...
const mergeConfig = isDev ? require('./webpack/webpack.config.dev.js') : require('./webpack/webpack.config.prod.js');

const file_entry = require('./webpack/webpack.config.entry.js');
...
const jsConfig = {
    ...
    resolve: {
        alias: {
            ...
            i18n: path.join(__dirname, '/src/js/i18n'),
